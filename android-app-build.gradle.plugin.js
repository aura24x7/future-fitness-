...
const withCustomAppBuildGradle = (config) => {
  return withDangerousMod(config, [
    ...
    async (config) => {
      ...
      // Create a custom app/build.gradle file with proper Firebase configuration
...
android {
    ...
    namespace "com.aifit.aifitness"
    defaultConfig {
        applicationId "com.aifit.aifitness"
...
apply from: file("../../node_modules/@react-native-community/cli-platform-android/native_modules.gradle"); applyNativeModulesAppBuildGradle(project)`;
      ...
      // Write the custom app/build.gradle file
